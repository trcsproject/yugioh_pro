...
function c101003025.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101003025.thfilter,tp,LOCATION_PZONE+LOCATION_EXTRA,0,1,nil) end
...
function c101003025.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c101003025.thfilter,tp,LOCATION_PZONE+LOCATION_EXTRA,0,1,1,nil)
